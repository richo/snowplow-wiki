...
For this reason, we strongly recommend that you also self-host a second tracking pixel, which serves effectively as a `/dev/null` for SnowPlow events on your development and test environments.
