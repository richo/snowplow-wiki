...
1. [Setup a bucket on Amazon S3 for the 1x1 tracking pixel](#bucket1) `ice.png`. This is the pixel that will be requested by every `GET` made by the SnowPlow tracker.
